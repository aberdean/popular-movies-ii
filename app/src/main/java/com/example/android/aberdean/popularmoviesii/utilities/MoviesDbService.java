...
public interface MoviesDbService {
    ...
    Call<ReviewsResponse> getReviews(@Path("id") int id, @Query("api_key") String API_KEY);

    @GET("movie/{id}/videos")
    Call<TrailersResponse> getTrailers(@Path("id") int id, @Query("api_key") String API_KEY);
}
